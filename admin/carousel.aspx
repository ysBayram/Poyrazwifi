<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="carousel.aspx.cs" Inherits="WebPortal_v1.admin.carousel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="widget mainForm" style="margin-top: 0px;">
        <div class="head">
            <h5 class="iCreate">Carousel Yönetimi</h5>
        </div>
        <div class="rowElem">
            <label>Başlık :</label>
            <div class="formRight">
        ...
        <div class="rowElem" style="padding:0px;">
            <div id="Div1" class="table" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptCarousel" runat="server" OnItemCommand="rptCarousel_ItemCommand">
                            <ItemTemplate>
